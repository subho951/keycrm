            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'companies',
                  'columns' => ['name', 'phone', 'email', 'contact_person', 'address', 'description', 'no_of_employee', 'industry_id', 'logo', 'created_at', 'companies.status'],
                  'visibleColumns' => ['name', 'phone', 'email', 'contact_person', 'address', 'description', 'no_of_employee', 'industry_name', 'logo', 'created_at'],    // used for rendering
                  'headers' => ['#', 'Name', 'Phone', 'Email', 'Contact Person', 'Address', 'Description', 'No. Of Employee', 'Industry', 'Logo', 'Created At'],
                  'filename' => "Company",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
